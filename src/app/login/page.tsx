...
function LoginContent() {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      ...
      if (callbackUrl) {
        // Redirect to agent auth with callback
        router.push(`/agent-auth?callback=${encodeURIComponent(callbackUrl)}`);
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        {/* Back to Home */}
        <div className="mb-8">
          <Link href="/" className="inline-flex items-center text-gray-600 hover:text-indigo-600 transition-colors">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-center text-sm text-gray-600">
              Need to authenticate your agent?{' '}
              <Link href="/agent-auth" className="font-semibold text-indigo-600 hover:text-purple-600 transition-colors">
        ...
        <p className="mt-6 text-center text-gray-600">
          ...
          <Link href="/signup" className="font-semibold text-indigo-600 hover:text-purple-600 transition-colors">
            Create account
          </Link>
        </p>
      </div>
